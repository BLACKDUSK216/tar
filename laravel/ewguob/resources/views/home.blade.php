      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="hero-content text-white text-center">
            ...
            <a href="{{ route('blogs') }}" class="btn btn-outline-light btn-lg text-white"><span>View More <i class="fas fa-arrow-right"></i></span></a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-6">
              <div class="about-me-content"><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
                ...
                <a href="{{ route('aboutme') }}"class="btn btn-outline-light btn-lg"><span>Contact Me <i class="fas fa-arrow-right"></span></i></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="gallery-div" class="py-5">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('gallery') }}" class="btn btn-outline-light"><span>View More <i class="fas fa-arrow-right"></i></span></a>
              </div>
          <div class="row">
            ...
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body text-white">
                  ...
                  <a href="{{ route('america') }}" class="btn btn-outline-light btn-lg"><span>Read More <i class="fas fa-arrow-right"></i></span></a>
                </div>
              </div>
            </div>
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body text-white">
                  ...
                  <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  <a href="{{ route('sydney') }}" class="btn btn-outline-light btn-lg"><span>Read More <i class="fas fa-arrow-right"></i></span></a>
                </div>
              </div>
            </div>
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body text-white">
                  ...
                  <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  <a href="{{ route('japan') }}" class="btn btn-outline-light btn-lg"><span>Read More <i class="fas fa-arrow-right"></i></span></a>
                </div>
              </div>
            </div>
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body text-white">
                  ...
                  <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  <a href="{{ route('africa') }}" class="btn btn-outline-light btn-lg"><span>Read More <i class="fas fa-arrow-right"></i></span></a>
                </div>
              </div>
            </div>
          </div>
