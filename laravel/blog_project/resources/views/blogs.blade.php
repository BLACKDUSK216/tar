      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="{{ route('blog1') }}" class="btn btn-outline-light btn-lg">Read More <i
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Lorem ipsum dolor sit amet, Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              ...
              illum, reprehenderit amet quod delectus sapiente eos magnam. consectetur adipiscing elit. Nulla convallis
              libero nec nunc aliquet, sed faucibus purus ultricies.</p>
            <a href="{{ route('blog2') }}" class="btn btn-outline-light btn-lg">Read More <i
                class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Lorem ipsum dolor sit amet, Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              ...
              illum, reprehenderit amet quod delectus sapiente eos magnam. consectetur adipiscing elit. Nulla convallis
              libero nec nunc aliquet, sed faucibus purus ultricies.</p>
            <a href="{{ route('japan') }}" class="btn btn-outline-light btn-lg">Read More <i
                class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
