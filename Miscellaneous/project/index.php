...
<body>
    <header>
        <nav class="nav-container navbar navbar-expand-lg navbar-light navbar-transparent text-white fixed-top">
            <a class="navbar-brand" href="index.html"><img src="images/logo-black.png" alt="My Logo"></a>
      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="hero-content text-white text-center">
            ...
            <a href="blogs.html" class="btn btn-outline-light btn-lg text-white"><span>View More <i class="fas fa-arrow-right"></i></span></a>
          </div>
        </div>
      </div>
    </div>
    <div class="btn-container">
              <button id="toggle-video" class="btn btn-outline-light btn-lg mt-3 plause" onclick="toggleVideo()"><span><i class="fa-solid fa-pause"></i></span></button>
              <button id="toggle-music" class="btn btn-outline-light btn-lg mt-3 plause" onclick="toggleMusic()"><span><i class="fa-solid fa-volume-xmark mute"></i></span></button>
            </div>
</div>
      ...
      <div id="about-me-div" class="parallax-div">
        <div class="container">
          <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-6">
              <div class="about-me-content"><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>

                <h2 class="mb-4">About Me</h2>
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus id tellus at quam faucibus placerat. Nullam sit amet elit ac ipsum congue feugiat. Sed tristique semper ex, eu lacinia lacus faucibus a. Nam vulputate rutrum mi, id efficitur nunc ullamcorper vel. Nulla facilisi.</p>
                <a href="aboutme.html" class="btn btn-outline-light btn-lg"><span>Contact Me <i class="fas fa-arrow-right"></span></i></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="gallery-div" class="py-5">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="gallery.html" class="btn btn-outline-light"><span>View More <i class="fas fa-arrow-right"></i></span></a>
              </div>
          <div class="row">
            ...
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body text-white">
                  ...
                  <a href="Americablog.html" class="btn btn-outline-light btn-lg"><span>Read More <i class="fas fa-arrow-right"></i></span></a>
                </div>
              </div>
            </div>
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body text-white">
                  ...
                  <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  <a href="sydney.html" class="btn btn-outline-light btn-lg"><span>Read More <i class="fas fa-arrow-right"></i></span></a>
                </div>
              </div>
            </div>
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body text-white">
                  ...
                  <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  <a href="japan.html" class="btn btn-outline-light btn-lg"><span>Read More <i class="fas fa-arrow-right"></i></span></a>
                </div>
              </div>
            </div>
            <div class="col-md-3 mb-4">
              <div class="card">
                ...
                <div class="card-body text-white">
                  ...
                  <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  <a href="afica.html" class="btn btn-outline-light btn-lg"><span>Read More <i class="fas fa-arrow-right"></i></span></a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <form>
        ...
        <div class="form-group">
          ...
          <input class="form-control" id="commentMessage" rows="3" placeholder="Enter Your comment...." required></input>
        </div>
        <div class="form-group">
        ...
        <div class="col-md-12">
          ...
          <div class="card1 mb-3">
            <div class="card-body text-white">
              ...
              <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sapiente dolores eius temporibus at distinctio voluptatibus fuga facere? Vel, provident! Placeat, quaerat dolorum alias unde impedit quae ex optio ullam excepturi.</p>
            </div>
          </div>
          <div class="card1 mb-3">
            <div class="card-body text-white">
              ...
              <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Omnis molestiae rem architecto facere! Quo, quisquam ipsam autem ducimus eaque cum hic placeat, tempore fuga ut fugiat minima, perferendis repellendus aut?</p>
            </div>
          </div>
        </div>
      </div>
...
<div id="footer" class="bg-dark text-white">
  ...
  <!-- <img src="images/airplane.png" alt="Airplane" id="airplane" style="position: absolute; display: none;"> -->
